  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Stronger left veil on mobile so type stays readable */}
        <div
          className="absolute inset-0 max-md:hidden"
          style={{
            background:
              "linear-gradient(90deg, rgba(7,7,7,0.96) 0%, rgba(7,7,7,0.82) 32%, rgba(7,7,7,0.35) 62%, rgba(7,7,7,0.22) 100%)",
          }}
          aria-hidden
        />
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(7,7,7,0.72) 0%, rgba(7,7,7,0.55) 35%, rgba(7,7,7,0.78) 70%, rgba(7,7,7,0.92) 100%)",
          }}
          aria-hidden
        />
      </div>

      <div className="bf-shell relative z-10 flex min-h-[calc(100svh-var(--bf-nav-h))] flex-col justify-end gap-6 pb-[max(1.25rem,env(safe-area-inset-bottom))] pt-3 lg:grid lg:grid-cols-12 lg:items-end lg:gap-8 lg:pb-12 lg:pt-4">
        <motion.div
        ...
        >
          ...
          >
            <p
              ...
              style={{
                color: "#f3f1ec",
                fontSize: "clamp(3.75rem, 16vw, 8.75rem)",
                lineHeight: 0.86,
          ...
          <motion.p
            ...
            style={{
              color: "#c8c4bb",
              fontSize: "clamp(1.15rem, 4.2vw, 1.95rem)",
          ...
          <motion.p
            variants={fadeMeta}
            className="mt-3 max-w-[36ch] text-[0.95rem] leading-relaxed sm:mt-4 sm:text-[1.05rem]"
            style={{ color: "#c8c4bb" }}
          >
          ...
          <motion.div className="bf-hero-ctas mt-6 sm:mt-7" variants={fadeMeta}>
            <Button
              href="/start-training"
